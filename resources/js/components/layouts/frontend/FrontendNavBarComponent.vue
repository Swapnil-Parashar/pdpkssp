<template>
    <header
        ...
        "
    >
        <div class="container py-3.5 lg:py-0">
            <div class="flex items-center justify-between gap-5">
                ...
                <form
                    ...
                    class="hidden w-full lg:w-40rem h-10 rounded-3xl lg:flex items-center gap-2 px-4 border border-gray-100 bg-gray-100 transition-all duration-300 focus-within:border-primary focus-within:bg-white"
                >
                    <button
                ...
                <div
                    class="hidden lg:flex call-block__text-wrapper items-center"
                >
                    <div
                        class="fas fa-phone-volume text-lg mr-2 text-secondary"
                        aria-hidden="true"
                    ></div>
        ...
        <div class="fixed top-[64px] left-0 z-10 w-full origin-top">
            <div class="coustom-container">
                ...
                >
                    <!-- <nav class="w-full flex items-center justify-center"> -->
                    <nav
                        class="container sticky top-0 z-10 flex items-center justify-between gap-5"
                    >
                        <router-link
                            v-for="(category, index) in categories"
                            :key="index"
                    ...
                    <div v-for="category in categories">
                        ...
                        >
                            ...
                            <div
                                class="w-full h-80 thin-scrolling pt-5 pr-5 text-white"
                            >
                                <div class="w-full grid gap-5 grid-cols-3">
                                    <div
