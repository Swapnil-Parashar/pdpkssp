    ...
    <header :class="isSticky === true ? 'fixed top-0 left-0 z-30 w-full mb-5 sm:mb-8 shadow-xs bg-white' : 'mb-5 sm:mb-8 shadow-xs bg-white'">
        <div class="container py-3.5 px-2 lg:py-0">
            <div class="flex items-center justify-between gap-5">
                ...
                <!-- Mobile Search Start -->
                <form @submit.prevent="search" class="hidden w-full lg:w-96 h-10 rounded-3xl lg:flex items-center gap-2 px-4 border border-gray-100 bg-gray-100 transition-all duration-300 focus-within:border-primary focus-within:bg-white">
