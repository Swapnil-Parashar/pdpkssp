            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        />
                        <span
                            class="text-sm sm:text-xl font-medium capitalize text-center py-2 px-3 overflow-hidden block rounded-bl-2xl rounded-br-2xl group-hover:text-primary flex-grow"
                        >
                            {{ category.name }}
                        </span>
                    </router-link>
